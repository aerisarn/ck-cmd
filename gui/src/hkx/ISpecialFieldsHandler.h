...
namespace ckcmd {
    namespace HKX {
        ...
        public:
            ...
            virtual QVariant handle(void* value, const hkClass*, const hkClassMember*) = 0;

            template<typename T>
            QVariant value(T& value, const hkClass* hkclass, const hkClassMember* hkmember) {
                return handle(&value, hkclass, hkmember);
            }
        };
