...
//			{
//				importVectorOfKeys(data->GetScaleKeys(), transforms, nbones, boneIdx, duration);
//			}
//		}
...
//			if (npoints > 3)
//			{
//				importVectorOfKeys(interp->SampleTranslateKeys(npoints, 3), transforms, nbones, boneIdx, duration);
//				importVectorOfKeys(interp->SampleQuatRotateKeys(npoints, 3), transforms, nbones, boneIdx, duration);
//				importVectorOfKeys(interp->SampleScaleKeys(npoints, 3), transforms, nbones, boneIdx, duration);
//			}
//			else
