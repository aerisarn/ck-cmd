...
string RetargetSkin::GetName() 
{
	return "retargetskin";
}

string RetargetSkin::GetHelp() 
{
	string name = GetName();
...
string RetargetSkin::GetHelpShort() 
{
...
bool RetargetSkin::InternalRunCommand(const CommandSettings& settings)
{
